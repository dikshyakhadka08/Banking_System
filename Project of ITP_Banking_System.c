//A local ISP is offering 25th Anniversary subscription offers for its customers and has introduced discount/deals on different packages purchased at a time for different range. You are required to make a prototype for its billing system.
